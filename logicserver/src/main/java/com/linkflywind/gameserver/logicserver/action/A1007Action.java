...
import com.linkflywind.gameserver.logicserver.room.message.XiaZhuMessage;
...
public class A1007Action extends BaseAction {
    ...
    public void action(TransferData optionalTransferData) throws IOException {
        ...
        actorRef.tell(new XiaZhuMessage(a1007Request.getChouma(),a1007Request.getType()),null);
    }
}
